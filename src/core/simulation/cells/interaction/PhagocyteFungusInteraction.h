...
#ifndef CORE_SIMULATION_PHAGOCYTEFUNGUSINTERACTION_H
#define CORE_SIMULATION_PHAGOCYTEFUNGUSINTERACTION_H
...
#endif /* CORE_SIMULATION_PHAGOCYTEFUNGUSINTERACTION_H */
