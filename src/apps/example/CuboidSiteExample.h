...
#ifndef CORE_SIMULATION_CuboidSiteExample_H
#define CORE_SIMULATION_CuboidSiteExample_H
...
class CuboidSiteExample : public Site {
 public:

  CuboidSiteExample(Randomizer *random_generator,
  ...
  [[nodiscard]] std::string getType() const override{return "CuboidSiteExample";}
...
#endif /* CORE_SIMULATION_CuboidSiteExample_H */